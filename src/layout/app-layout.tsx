...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['healthcare-provider', 'owner', 'administrator'];
  ...
  const { data, error, isLoading } = useSWR<ProviderInterface[]>(
    ...
    () => getProviders({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Doctor', path: '/doctors', entity: 'doctor', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    { name: 'Hospital', path: '/hospitals', entity: 'hospital', service: AccessServiceEnum.PROJECT, icon: FiHome },
